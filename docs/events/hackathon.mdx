...
### Do the contributions I make during hacktoberfest count?
- No. Only those made during the hackathon period (15-17) will count.

### Will submissions on existing issues count?
- Yes. But make sure you say you are working on an issue to avoid submissions of multiple pull requests.
